...
class RAGbase:
    ...
    def build_prompt(self, querry, search_results):
        context = self.build_context(search_results)
        return self.prompt_template.format(
            question = querry, context = context 
        )
    ...
    def rag(self, querry):
        search_results = self.search(querry)
        prompt = self.build_prompt(querry, search_results)
